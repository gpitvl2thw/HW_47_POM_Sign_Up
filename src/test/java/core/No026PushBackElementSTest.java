...
public class No026PushBackElementSTest {
	...
	public static Collection<String[]> data() throws IOException {
		core.No026PushBackElementS propertiesLoad = new core.No026PushBackElementS();
		return Arrays.asList(propertiesLoad.No026PushBackElementSToS2D(strNP));
	}
