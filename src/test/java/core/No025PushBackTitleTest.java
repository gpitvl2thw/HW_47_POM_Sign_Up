...
public class No025PushBackTitleTest {
	...
	public static Collection<String[]> data() throws IOException {
		core.No025PushBackTitle propertiesLoad = new core.No025PushBackTitle();
		return Arrays.asList(propertiesLoad.No025PushBackTitleToS2D(strNP));
	}
