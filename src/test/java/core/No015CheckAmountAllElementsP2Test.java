...
public class No015CheckAmountAllElementsP2Test {
	...
	public static Collection<String[]> data() throws IOException {
		core.No005CheckAmountAllElements propertiesLoad = new core.No005CheckAmountAllElements();
		return Arrays.asList(propertiesLoad
				.No005CheckAmountAllElementsToS2D(strNP));
	}
	...
	@Test
	public void testCheckAmountAllElementsValidation() throws ComparisonFailure {
