...
public class No018CheckTable2P2Test {
	...
	public static Collection<String[]> data() throws IOException {
		core.No008CheckTable2 propertiesLoad = new core.No008CheckTable2();
		return Arrays.asList(propertiesLoad.No008CheckTable2ToS2D(strNP));
	}
