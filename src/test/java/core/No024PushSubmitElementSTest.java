...
public class No024PushSubmitElementSTest {
	...
	public static Collection<String[]> data() throws IOException {
		core.No024PushSubmitElementS propertiesLoad = new core.No024PushSubmitElementS();
		return Arrays.asList(propertiesLoad.No024PushSubmitElementSToS2D(strNP));
	}
