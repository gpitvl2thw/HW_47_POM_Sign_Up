...
public class No009CheckTable4Test {
	...
	public static Collection<String[]> data() throws IOException {
		core.No009CheckTable4 propertiesLoad = new core.No009CheckTable4();
		return Arrays.asList(propertiesLoad.No009CheckTable4ToS2D(strNP));
	}
