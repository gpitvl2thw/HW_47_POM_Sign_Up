...
public class No022PushResetElementSTest {
	...
	public static Collection<String[]> data() throws IOException {
		core.No022PushResetElementS propertiesLoad = new core.No022PushResetElementS();
		return Arrays.asList(propertiesLoad.No022PushResetElementSToS2D(strNP));
	}
