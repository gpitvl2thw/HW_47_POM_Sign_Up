...
public class No020CheckTable3P2Test {
	...
	public static Collection<String[]> data() throws IOException {
		core.No010CheckTable3 propertiesLoad = new core.No010CheckTable3();
		return Arrays.asList(propertiesLoad.No010CheckTable3ToS2D(strNP));
	}
