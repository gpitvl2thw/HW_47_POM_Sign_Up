	...
	public String[][] No009CheckTable4ToS2D(String strNP) {
		...
		for (int i = 0;; i++) {
			try {
				...
				nElNew = No000ValuesAndMetods.getPropertyes(nElOld, strNP); // timestamp
				nElNewLook = No000ValuesAndMetods.getPropertyes(nElOld
						+ "_look", strNP); // table4_1_look
		...
		if (!No000ValuesAndMetods.getContinueTC()) {
			...
			No000ValuesAndMetods.setContinueErr("ERROR IN - No009CheckTable4");
		}
