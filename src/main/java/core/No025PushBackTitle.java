...
/*
 * проверка No025PushBackTitle
 */
public class No025PushBackTitle {
	...
	// номер элемента - button = 9 - id_submit_button
	private String buttonP2 = No000ValuesAndMetods.getAllElements(
			noElemAllElementsP2, "P2");
	// 1-TC_ID, 2-exp., 3-act.
	...
	public String[][] No025PushBackTitleToS2D(String strNP) {
		...
		// 3333
		// нажимаем кнопку - button = 1 - id_back_button
		// поиск элемента
		try {
			...
			if (!No000ValuesAndMetods.getContinueTC()) {
				...
				String[][] str = { { "1", "can't found element - " + buttonP2,
						"" } };
				dr.quit();
				return str;
			} // if (!No000ValuesAndMetods.getContinueTC()) {
		...
		s2d[0][1] = No000ValuesAndMetods.getPropertyes(No000ValuesAndMetods
				.getAllElements(noElemAllElementsTitle, strNP), strNP);
		s2d[0][2] = dr.getTitle();
	...
	/*
	 * public static void main(String[] args) { No025PushBackTitle qwe = new
	 * No025PushBackTitle(); String[][] as = qwe.No025PushBackTitleToS2D("P1");
